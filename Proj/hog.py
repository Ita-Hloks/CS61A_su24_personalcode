...
def boar_brawl(player_score, opponent_score):
    ...
    if opponent_score < 10:
        ...
        o_ten = (opponent_score // 10) % 10
    p_one = player_score % 10
    score = 3 * abs(o_ten - p_one)
    if score == 0:
        return 1
    return score
    # END PROBLEM 2
...
def sus_points(score):
    ...
    if num_factors(score) == 3 or num_factors(score) == 4:
        while not is_prime(score):  # 如果是 score 未循环就是质数，那么 num_factors 就不会大于 2
            score += 1
        return score
    else:
        return score
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # 更新函数。但 sus 的更新因在 simple 之后，所以设置此函数
    return score
    # END PROBLEM 4
...
def is_always_roll(strategy, goal=GOAL):
    ...
    "*** YOUR CODE HERE ***"
    score1, score0 = 0, 0
    reference = strategy(score0, score1)
    while score0 < goal:
        score1 = 0
        while score1 < goal:
...
def make_averaged(original_function, samples_count=1000):
    ...
    >>> dice = make_test_dice(4, 2, 5, 1) # 仅仅是先告诉你那些数字参与循环
    >>> averaged_dice = make_averaged(roll_dice, 40) # 这里可以尝试除以40
    >>> averaged_dice(1, dice)  # The avg of 10 4's, 10 2's, 10 5's, and 10 1's #前两个数为一组，不可以直接记为乘以多少 （好像可以）
    3.0
    """
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    judgement = boar_brawl(score, opponent_score)
    if judgement >= threshold:
        return 0
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    judgement = sus_update(0, score, opponent_score, num_rolls)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    judgement0 = sus_update(0, score, opponent_score)
    judgement6 = sus_update(6, score, opponent_score)
    if judgement0 > judgement6:
        return 0
