...
class Player:
    ...
    def debate(self, other):
        "*** YOUR CODE HERE ***"
        odds = max(0.1, self.popularity / (self.popularity + other.popularity))
        if self.random_func() < odds:
            self.popularity += 50
        else:
    ...
    def speech(self, other):
        ...
        the_minus = other.popularity // 10
        other.popularity = max(0, other.popularity - the_minus)
